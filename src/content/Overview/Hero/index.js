                ...
                <Grid item md={6} pr={{ xs: 0, md: 3 }}>
                    ...
                    <ListItemWrapper sx={{ mt: 5, mb: 2 }}>
                        ...
                        <Typography variant="h6">
                            ...
                            <Typography component="span" variant="subtitle2">
                                ...
                                experience with all the features you need for
                                production.
                            </Typography>
                        </Typography>
                    </ListItemWrapper>
                    ...
                    >
                        ...
                        <Typography variant="h6">
                            ...
                            <Typography component="span" variant="subtitle2">
                                {" "}
                                - A simple and customizable component library to
                                build faster, beautiful, and accessible React
                                apps.
                            </Typography>
                        </Typography>
                    </ListItemWrapper>
                    <ListItemWrapper>
                        ...
                        <Typography variant="h6">
                            ...
                            <Typography component="span" variant="subtitle2">
                                {" "}
                                - Tokyo features a modern technology stack and
                                is built with React + Javascript.
                            </Typography>
                        </Typography>
                    </ListItemWrapper>
                </Grid>
