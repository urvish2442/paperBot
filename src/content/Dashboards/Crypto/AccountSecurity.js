        ...
        <Card>
            ...
            <List disablePadding>
                ...
                >
                    ...
                    <ListItemText
                        primary={
                            <Text color="black">{t("2FA Authentication")}</Text>
                        }
                ...
                >
                    ...
                    <ListItemText
                        primary={
                            <Text color="black">{t("Phone Verification")}</Text>
                        }
                        primaryTypographyProps={{
                            variant: "body1",
                            fontWeight: "bold",
                ...
                >
                    ...
                    <ListItemText
                        primary={
                            <Text color="black">{t("Recovery Email")}</Text>
                        }
                        primaryTypographyProps={{
                            variant: "body1",
                            fontWeight: "bold",
                        ...
                        secondary={
                            <Text color="warning">{t("Not completed")}</Text>
                        }
                        secondaryTypographyProps={{
                            variant: "body2",
                            noWrap: true,
