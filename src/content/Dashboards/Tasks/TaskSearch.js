            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={4}>
                    ...
                    >
                        ...
                        <Link href="#" variant="h3" color="text.primary">
                            Migrate hosting to a more performant web server
                            datacenter
                        </Link>
                        <Box
                            sx={{
                        ...
                        >
                            ...
                            looking at its layout beatae vitae dicta sunt
                            explicabo.
                        </Typography>
                ...
                <Grid item xs={12} md={4}>
                    ...
                    >
                        ...
                        <Link href="#" variant="h3" color="text.primary">
                            Improve conversion rated by integrating new
                            analytics tools
                        </Link>
                        <Box
                            sx={{
                ...
                <Grid item xs={12} md={4}>
                    ...
                    >
                        ...
                        <Link href="#" variant="h3" color="text.primary">
                            Increase the website speed on mobile and tablet
                            devices
                        </Link>
                        <Box
                            sx={{
                        ...
                        <Typography
                            ...
                            color="text.secondary"
                        >
                            Nemo enim ipsam voluptatem quia accusantium
                            doloremque laudantium voluptas sit aspernatur aut
